...
#difference between calcupdownresponses_noisyup_one_old3.py: syn1coeff changed from 0.5 to 0.85
      ...
      for iallmutval in range(0,cumprodnVals[len(MT[igene][imut])-1]):
        ...
        for iiter in range(0,len(iters)):
          ...
          if len(sys.argv) > 3 and mutcounter != int(sys.argv[3]):
            continue
          if exists('updownresponse_noisyup2_cs'+str(icell)+'_dist'+str(proximalpoints[idist])+'_'+str(distalpoints[idist])+'_syn1coeff'+str(syn1coeff)+'_'+str(igene)+'_'+str(imut)+'_'+str(iallmutval)+'_'+str(iter)+'_'+str(rateCoeff)+'_seed'+str(rdSeed)+'_tmp.sav'):
            print 'updownresponse_noisyup2_cs'+str(icell)+'_dist'+str(proximalpoints[idist])+'_'+str(distalpoints[idist])+'_syn1coeff'+str(syn1coeff)+'_'+str(igene)+'_'+str(imut)+'_'+str(iallmutval)+'_'+str(iter)+'_'+str(rateCoeff)+'_seed'+str(rdSeed)+'_tmp.sav exists, continuing...'
            continue
          CasomaupThisIter = []
          SKsomaupThisIter = []
          VdendupThisIter = []
...
""")
              ...
              if epspdts[idt] in epspdts_savetimecourses:
                ...
                file = open('updownresponsetimecourse_noisyup2_cs'+str(icell)+'_dist'+str(proximalpoints[idist])+'_'+str(distalpoints[idist])+'_syn1coeff'+str(syn1coeff)+'_'+str(igene)+'_'+str(imut)+'_'+str(iallmutval)+'_'+str(iter)+'_'+str(rateCoeff)+'_seed'+str(rdSeed)+'.sav', 'w')
...
"""+mutvar+""" = """+str(newVal[whichDefVal[iupdated]])+"""
          ...
          file = open('updownresponse_noisyup2_cs'+str(icell)+'_dist'+str(proximalpoints[idist])+'_'+str(distalpoints[idist])+'_syn1coeff'+str(syn1coeff)+'_'+str(igene)+'_'+str(imut)+'_'+str(iallmutval)+'_'+str(iter)+'_'+str(rateCoeff)+'_seed'+str(rdSeed)+'_tmp.sav', 'w')
          pickle.dump(picklelist,file)
          file.close()
